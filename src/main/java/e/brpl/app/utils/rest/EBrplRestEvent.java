...
public interface EBrplRestEvent<Entity extends EBrplEntityEvent, ID extends Serializable> extends EBrpl {
     ...
     * @return ResponseEntity
     */
    ResponseEntity<Entity> edit(@PathVariable(PK_PATH_VARIABLE) ID uuid, @Valid @RequestBody Entity entity);
     ...
     * @return ResponseEntity
     */
    ResponseEntity<Entity> findOne(@PathVariable(PK_PATH_VARIABLE) ID uuid);
     ...
     * @return ResponseEntity
     */
    ResponseEntity<Entity> delete(@PathVariable(PK_PATH_VARIABLE) ID uuid);
